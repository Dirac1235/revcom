        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href={ROUTES.LISTINGS} className="text-muted-foreground hover:text-foreground transition-colors">
                  Buyer Requests
                </Link>
              </li>
              <li>
                <Link href={ROUTES.SELLER_EXPLORE} className="text-muted-foreground hover:text-foreground transition-colors">
                  Sell on RevCom
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href={ROUTES.BUYER_REQUEST_CREATE} className="text-muted-foreground hover:text-foreground transition-colors">
                  Post a Request
                </Link>
              </li>
              <li>
                <Link href={ROUTES.BUYER_REQUESTS} className="text-muted-foreground hover:text-foreground transition-colors">
                  My Requests
                </Link>
              </li>
              <li>
                <Link href={ROUTES.BUYER_ORDERS} className="text-muted-foreground hover:text-foreground transition-colors">
                  My Orders
                </Link>
              </li>
              <li>
                <Link href={ROUTES.MESSAGES} className="text-muted-foreground hover:text-foreground transition-colors">
                  Messages
                </Link>
              </li>
            </ul>
