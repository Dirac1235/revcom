      ...
      <div className={`flex flex-col gap-0.5 max-w-[68%] ${isMe ? "items-end" : "items-start"}`}>
        <div
          className={`
            ...
            ${isMe
              ? "bg-foreground text-background rounded-2xl rounded-br-[5px]"
              : "bg-foreground/7 text-foreground rounded-2xl rounded-bl-[5px]"
            }
          `}
        >
          {message.content}
        </div>
        <span className="text-[10px] text-foreground/30 px-1 tabular-nums">
      ...
      <div className="shrink-0 px-4 py-3 border-t border-foreground/8">
        <div className="flex items-end gap-2">
          ...
          <button
            ...
            className="
              w-10.5 h-10.5 rounded-2xl shrink-0
