        ...
        <div className="flex justify-between items-center mb-12">
          <div>
            ...
            <p className="text-muted-foreground text-lg">
              Create and manage your buyer requests
            </p>
          </div>
          ...
          {requests && requests.length > 0 ? (
              ...
              >
                <CardHeader className="pb-2 pt-6 px-6">
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle className="text-xl font-medium text-foreground">{request.title}</CardTitle>
            ...
            <Card className="border-dashed border-border shadow-none rounded-lg bg-transparent">
              <CardContent className="py-12 text-center">
                ...
                <Link href="/buyer/requests/create">
                  <Button className="bg-foreground text-background hover:bg-foreground/90 shadow-none">Create Your First Request</Button>
                </Link>
              </CardContent>
            </Card>
          )}
