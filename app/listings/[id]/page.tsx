  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Link href="/listings" className="flex items-center gap-2 text-primary hover:underline mb-6">
          ...
          <CardHeader>
            <div className="flex justify-between items-start">
              <div>
                ...
                <CardDescription className="text-base">{listing.category}</CardDescription>
              </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-card border border-border rounded-lg p-4">
              ...
              <p className="text-muted-foreground mb-1">
                <span className="font-medium">Name:</span> {listing.profiles?.full_name || "Anonymous"}
              </p>
            ...
            <div className="flex gap-2 pt-4">
              ...
              {user && listing.buyer_id !== user.id ? (
                ...
                <Link href="/auth/sign-up">
                  <Button>Sign Up to Send Offer</Button>
                </Link>
              ) : null}
            </div>
          </CardContent>
