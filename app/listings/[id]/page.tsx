...
export default async function RequestDetailPage({
  ...
  // If we have offers, fetch the seller profiles separately
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                <h1 className="text-4xl sm:text-5xl font-bold font-serif text-foreground leading-tight mb-3">
                  {request.title}
                </h1>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                ...
                {deadlineDate && (
                  <div
                    className={`flex items-center gap-1.5 font-semibold ${isDeadlinePassed ? "text-red-600" : daysUntilDeadline && daysUntilDeadline <= 3 ? "text-amber-600" : ""}`}
                  >
                      ...
                      {sellerHasOffer ? (
                        <Alert className="border-amber-200 bg-amber-50 py-3">
                          ...
                          <AlertDescription className="text-amber-700 text-xs mt-1">
                            Your offer is listed below. Message buyer to
                            negotiate.
                          </AlertDescription>
                        </Alert>
                      ) : (
            ...
            <Card className="border-border/30 border-dashed">
              <CardContent className="pt-8 pb-8">
                ...
                <p className="text-muted-foreground text-sm mb-6 max-w-sm mx-auto">
                  This is a new request. Be the first seller to respond and
