...
function StatCard({
  ...
  const content = (
    <Card
      className={`border-border shadow-none hover:shadow-md transition-all hover:-translate-y-0.5 ${urgent && Number(value) > 0 ? "border-red-200 dark:border-red-800" : ""}`}
    >
    ...
    <div className="min-h-screen bg-background">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeRole === "buyer" && isBuyer && (
          <BuyerDashboard data={data} firstName={firstName} />
        )}
